    ...
    <ul class="navbar-nav mr-auto">
      ...
      <!-- code for men dropdown -->
            ...
            <!-- code for women dropdown -->
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="myprofileview.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Women
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
...
echo "<h1  class = 'f'> Western Dresses</h1><hr>";

echo "<table style='font-family:Futura Lt BT; font-weight:400;
...
echo "<td class = 'imgbg'>
<a href ='DisplayProduct.php?p=$row[1]&p2=$row[0]&p3=$row[2]'><img src ='".$row['Imagepath']."' height = 260 width = 180> </a><br> <font style = 'font-family:Rupee Foradian'> </font>&#8377 ".$row['Price']."<br>".$row['Description'];
