...
$result = mysqli_query($db,"SELECT * FROM men ");

echo "<h1  class = 'f'>All men items</h1><hr>";

echo "<table style='font-family:Futura Lt BT; font-weight:400; border-collapse: separate;
