...
$result = mysqli_query($db,"SELECT * FROM men where ProductType='Slogan T-shirts' OR ProductType='V-neck T-shirts' OR ProductType='Round neck T-shirts' ");

echo "<h1  class = 'f'> T-shirts</h1><hr>";
