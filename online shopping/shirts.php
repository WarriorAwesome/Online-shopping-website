...
$result = mysqli_query($db,"SELECT * FROM woman where ProductType='Tshirts-Shirts-Tunics-maxi-gown'");

echo "<h1  class = 'f'>Tshirts and Shirts</h1><hr>";

echo "<table cellspacing = 10 cellpadding = 10 style='font-family:Futura Lt BT; font-weight:400; border-collapse: separate;
   border-spacing: 80px;'> <tr>";
