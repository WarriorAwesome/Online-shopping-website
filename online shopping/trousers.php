...
$result = mysqli_query($db,"SELECT * FROM woman where ProductType='Trousers and shorts-Pants & Palazzos'");

echo "<h1  class = 'f'>Trousers and shorts-Pants & Palazzos</h1><hr>";

echo "<table cellspacing = 10 cellpadding = 10 style='font-family:Futura Lt BT; font-weight:400;
